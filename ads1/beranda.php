...
<script src="js/index-search.js"></script>
 ...
 $query = mysql_query("select * from jalan");
    ...
    <?php }?>
                        ...
                        <li>
                            <a href="#" data-toggle="modal" data-target="#myModal_1"><i class="fa fa-edit fa-fw"></i> Poin</a>                         <!-- Modal -->
<div class="modal fade" id="myModal_1" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
        <h4 class="modal-title" id="myModalLabel">Data Poin & Koin <?php echo $_SESSION['nama']?></h4>
      </div>
      <div class="modal-body">
          <form class="form-signin" method="post" action="fungsi/koin.php?id=<?php echo $_SESSION['id_anggota']?>" role="form">
       <fieldset disabled>
  <div class="form-group  ">
    <label for="disabledTextInput">Perolehan Poin</label>
    <input type="text" class="form-control" id="disabledInput" name="username"  value="<?php echo $var1['jumlah']?>">
  </div>
  </fieldset>
<fieldset disabled>
  <div class="form-group  ">
    <label for="disabledTextInput">Perolehan Koin</label>
    <input type="text" class="form-control" id="disabledInput" name="username"  value="<?php echo $var2['jumlah']?>">
  </div>
  </fieldset>
  <fieldset>
  <div class="form-group  ">
    <label for="disabledTextInput">Nominal Koin</label>
    <input type="text" class="form-control" id="disabledInput" name="koin"  placeholder="Enter Koin">
  </div>
  </fieldset>
        <div class="checkbox">
          <label>
        ...
        <button class="btn btn-lg btn-primary btn-block" type="submit">Generate</button>
                        ...
                        <?php } else {?>
                        <li>
                            <a href="#"><span class="glyphicon glyphicon-copyright-mark"></span> Poin</a>                         
                        </li>
                         <?php }?>
                         <?php if ($_SESSION['level']=="member") {?>
                       <li>
