                ...
                function map_initialize()
                {
					 ...
					 $.get("map_process.php", function(data) {
                        $(data).find("marker1").each(function() {
                           ...
                           var type = $(this).attr('type');
                            ...
                            create_marker(point, name, address, false, false, false,"http://localhost/rpl_kelompok2/img/merah.png");
                        });
                    });
					...
					$.get("map_process.php", function(data) {
                        $(data).find("marker2").each(function() {
                           ...
                           var type = $(this).attr('type');
                            var point = new google.maps.LatLng(parseFloat($(this).attr('lat')), parseFloat($(this).attr('lng')));
                            create_marker(point, name, address, false, false, false,"http://localhost/rpl_kelompok2/img/biru.png");
                        });
                    });
					...
					$.get("map_process.php", function(data) {
                        $(data).find("marker").each(function() {
                            ...
                            var type = $(this).attr('type');
                            var point = new google.maps.LatLng(parseFloat($(this).attr('lat')), parseFloat($(this).attr('lng')));
                            create_marker(point, name, address, false, false, false,"http://localhost/rpl_kelompok2/img/hijau.png");
                        });
                    });
					...
					$.get("map_process.php", function(data) {
                        $(data).find("marker").each(function() {
                            ...
                            var type = $(this).attr('type');
                            var point = new google.maps.LatLng(parseFloat($(this).attr('lat')), parseFloat($(this).attr('lng')));
                            create_marker1(point, name, address, false, false, false,"http://localhost/rpl_kelompok2/img/hijau.png");
                        });
                    }); <?php } else {?>  
					...
					$.get("map_process.php", function(data) {
                        $(data).find("marker").each(function() {
                            ...
                            var type = $(this).attr('type');
                            var point = new google.maps.LatLng(parseFloat($(this).attr('lat')), parseFloat($(this).attr('lng')));
                            create_marker3(point, name, address, false, false, false,"http://localhost/rpl_kelompok2/img/hijau.png");
                        });
                    }); 
				   ...
				   google.maps.event.addListener(map, 'rightclick', function(event) {
                        ...
                        create_marker1(event.latLng, 'New Marker', EditForm, true, true, true, "http://localhost/rpl_kelompok2/img/biru.png");
                    });<?php } else { ?> <?php }?>
                ...
                function save_marker(Marker, replaceWin)
                {
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            Marker.setIcon('http://localhost/rpl_kelompok2/img/biru.png'); //replace icon
                        },
                        error: function(xhr, ajaxOptions, thrownError) {
                            alert(thrownError); //throw any errors
                        }
