            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <?php } else {?>
                        <li>
                            <a href="jalan.php"><span class="glyphicon glyphicon-copyright-mark"></span> DB jalan</a>                         
                        </li>
                         <?php }?>
                         <?php if ($_SESSION['level']=="member") {?>
                       <li>
...
<div class="modal fade" id="myModaaa" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  ...
  <button type="submit" name="submit" class="btn btn-default btn-danger btn-lg">update</button>
        ...
        <div class="col-md-10">
         ...
         <h2 align="center">Data Member Adobt Dustbin System</h2>
         <form method="post" id="sort" action="member2.php" onKeyPress="member2.php"><select name="sorting"><option value="">Sorting</option>
<option value="asc">Ascending</option>
<option value="desc">Descending</option>
</select> <input  align="middle" type="submit" name="button" id="button" value="Ok">
...
border-radius: 5px;"> <tr>
        	    ...
        	    <td width="365" align="center" valign="middle">Nama</td>
...
<td width="232" align="center" valign="middle">Aksi</td>
        	    </tr>
    <tr>
            ...
            <?php
 $query = mysql_query("select * from sampah ORDER BY nama $var");$vb=1;
            while ( $data = mysql_fetch_array($query) )
            { ?> 
            <tr>
        	    
       	      <td width="85" align="center" id="tex_dlm"><?php echo $vb ?></td>
                <td align="center"><?php echo $data['nama']?></td>
        	    <td align="center"><?php echo $data['lat']?></td>
        	    <td align="center"><?php echo $data['lng']?></td>
        	    <td align="center"><?php echo $data['lng']?></td>
                <td align="center"> <li>
                            <a href="" data-toggle="modal" data-target="#myModal<?php echo $vb?>"><input  align="middle" type="button" name="button" id="button" value="Ok"></a>
                             <!-- Modal -->
<div class="modal fade" id="myModal<?php echo $vb?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
        <h4 class="modal-title" id="myModalLabel">Input Nilai <?php echo $data['nama']?></h4>
      </div>
      <div class="modal-body">
          <form class="form-signin" method="post" action="fungsi/nilai.php?id=<?php echo $data['id_anggota']?>" role="form">
       
        <label for="inputEmail" class="sr-only">Keutuhan</label>
        <input type="text" class="form-control" name="Keutuhan" id="exampleInputEmail2" placeholder="Keutuhan">
        <label for="inputPassword" class="sr-only">Keterpilahan</label>
        <input type="text" name="Keterpilahan" class="form-control" id="exampleInputPassword2" placeholder="Keterpilahan">
        <div class="checkbox">
          <label>
